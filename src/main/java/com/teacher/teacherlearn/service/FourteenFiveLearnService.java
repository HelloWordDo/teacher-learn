...
import com.teacher.teacherlearn.fourteen_five.course.GetData;
import com.teacher.teacherlearn.fourteen_five.course.pojo.CourseResp;
import com.teacher.teacherlearn.fourteen_five.course.pojo.LearnMessage;
import com.teacher.teacherlearn.fourteen_five.course.pojo.ModuleResp;
import com.teacher.teacherlearn.fourteen_five.course.pojo.VideoResp;
import com.teacher.teacherlearn.fourteen_five.exam.Exam;
import com.teacher.teacherlearn.fourteen_five.exam.pojo.ExamRequest;
...
@Slf4j
@Service
public class FourteenFiveLearnService {
    ...
    public void learn(User u, FourteenFive fourteenFive) throws IOException, InterruptedException {
        ...
        String uToken = loginService.login(u.getUserName(), u.getPassWord(), fourteenFive.getPlatformId(), fourteenFive.getService());
        String exp = "";
        try {
...
//                            }
                            ...
                            if (Long.parseLong(exp) - now < 60 * 60) {
                                ...
                                uToken = loginService.login(u.getUserName(), u.getPassWord(), fourteenFive.getPlatformId(), fourteenFive.getService());
                                exp = jwt.decodeJwt(uToken);
                            }
