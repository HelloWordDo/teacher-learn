...
import com.teacher.teacherlearn.curl_14_5.common.YongData;
...
public class Run14_5_YongFei {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Jwt j = new Jwt();
        String uToken = login.login(YongData.userName, YongData.passWord, YongData.platformId, YongData.service);
        String exp = j.decodeJwt(uToken);
        List<LearnMessage> learnMessages = g.getSegIdAndItemId(uToken, YongData.projectId, YongData.classId);
                ...
                for (CourseResp.CourseData.Cuorses.Detail c : courses) {
                    ...
                    if (c.getCourseProgress().equals("100")) {
                        ...
                        if (!c.getExamProgress().equals("100")) {
                            ...
                            Exam exam = new Exam();
                            exam.excamChain(uToken, YongData.projectId, YongData.classId, learn.getItemId(), c.getItemExamId(), learn.getSegId());
                        }
                        continue;
                    }
...
//                            }
                            ...
                            if (Long.parseLong(exp) - now < 60 * 60) {
                                ...
                                uToken = login.login(YongData.userName, YongData.passWord, YongData.platformId, YongData.service);
                            ...
                            res = g.watch(learn.getSegId(), learn.getItemId(), c.getCourseId(), videoId, String.valueOf(playProgress), uToken, YongData.projectId, YongData.orgId);
